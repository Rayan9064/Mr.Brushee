...
const Navbar = () => {
  ...
  return (
    <nav className="absolute top-0 left-0 right-0 mx-4 md:mx-8 lg:mx-16 xl:mx-24 2xl:mx-32 p-4 md:p-6 xl:p-8 flex justify-between items-center z-10">
      ...
      <button onClick={handleBuyNow} className="bg-red-500 hover:bg-red-600 text-white px-4 md:px-6 lg:px-8 xl:px-10 py-2 xl:py-3 rounded-full text-sm md:text-base xl:text-base font-medium transition-colors">
        Buy Now
      </button>
    </nav>
  );
